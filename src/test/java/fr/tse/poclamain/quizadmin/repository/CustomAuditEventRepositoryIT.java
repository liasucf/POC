...
import fr.tse.poclamain.quizadmin.config.audit.AuditEventConverter;
import fr.tse.poclamain.quizadmin.domain.PersistentAuditEvent;
...
import static fr.tse.poclamain.quizadmin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

...
import fr.tse.poclamain.quizadmin.domain.Media;
import fr.tse.poclamain.quizadmin.repository.MediaRepository;
import fr.tse.poclamain.quizadmin.service.MediaService;
import fr.tse.poclamain.quizadmin.service.dto.MediaDTO;
import fr.tse.poclamain.quizadmin.service.mapper.MediaMapper;
...
public class MediaResourceIT {
    ...
    public void createMedia() throws Exception {
        ...
        assertThat(testMedia.getIntitule()).isEqualTo(DEFAULT_INTITULE);
    ...
    public void updateMedia() throws Exception {
        ...
        Media testMedia = mediaList.get(mediaList.size() - 1);
        assertThat(testMedia.getIntitule()).isEqualTo(UPDATED_INTITULE);

...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.adminService
      ...
      .subscribe(
        (res: HttpResponse<IAdmin[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInAdmins(): void {
    this.eventSubscriber = this.eventManager.subscribe('adminListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAdmin[] | null, headers: HttpHeaders, page: number): void {

...
/**
 * REST controller for managing {@link fr.tse.poclamain.quizadmin.domain.Theme}.
 */
@RestController
@RequestMapping("/api")
public class ThemeResource {
    ...
    public ResponseEntity<ThemeDTO> updateTheme(@RequestBody ThemeDTO themeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, themeDTO.getId().toString()))
            .body(result);
    }
